...
var _excluded = ["className", "cssModule", "type", "bsSize", "valid", "invalid", "bgColor", "noBorder", "tag", "addon", "plaintext", "innerRef"];
...
var Input = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var classes = (0, _utils.mapToCssModules)((0, _classnames["default"])(className, invalid && 'is-invalid', valid && 'is-valid', bgColor ? "bg-".concat(bgColor) : false, bsSize ? selectInput ? "form-select-".concat(bsSize) : "form-control-".concat(bsSize) : false, noBorder ? "border-none" : "", formControlClass), cssModule);
