...
var _excluded = ["className", "cssModule", "noGutters", "alignCenter", "gutterSize", "tag", "form", "widths"];
...
var Row = function Row(props) {
  ...
  var classes = (0, _utils.mapToCssModules)((0, _classnames["default"])(className, noGutters ? 'gx-0' : null, alignCenter ? 'align-items-center' : null, gutterSize ? "g-".concat(gutterSize) : null, form ? 'form-row' : 'row', colClasses), cssModule);
