...
var _excluded = ["className", "cssModule", "widths", "relative", "absolute", "tag"];
...
var colWidths = ['auto', 'xs', 'sm', 'md', 'lg', 'xl', 'xxl'];
...
var Col = function Col(props) {
  ...
  var classes = (0, _utils.mapToCssModules)((0, _classnames["default"])(relative ? 'position-relative' : false, absolute ? 'position-absolute' : false, className, colClasses), cssModule);
