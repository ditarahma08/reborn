...
var propTypes = {
  ...
  modalSquare: _propTypes["default"].bool,
  modalMobile: _propTypes["default"].bool
};
  ...
  _createClass(Modal, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (this.props.isOpen && !prevProps.isOpen) {
        this.init();
        this.setIsOpen(); // let render() renders Modal Dialog first
    ...
    value: function trapFocus(ev) {
      ...
      if (this.modalIndex < Modal.openCount - 1) // last opened modal
        return;
      var children = this.getFocusableChildren(); // eslint-disable-next-line no-plusplus
    ...
    value: function renderModalDialog() {
      ...
      var _this$props2 = this.props,
          ...
          modalSquare = _this$props2.modalSquare,
          modalMobile = _this$props2.modalMobile;
      ...
      return /*#__PURE__*/_react["default"].createElement("div", _extends({}, attributes, {
        className: (0, _utils.mapToCssModules)((0, _classnames["default"])(dialogBaseClass, this.props.className, bottomSheet && 'modal-bottom', (_classNames = {}, _defineProperty(_classNames, "modal-".concat(this.props.size), this.props.size), _defineProperty(_classNames, "".concat(dialogBaseClass, "-centered"), this.props.centered), _defineProperty(_classNames, "".concat(dialogBaseClass, "-scrollable"), this.props.scrollable), _classNames)), this.props.cssModule),
        role: "document",
        ref: function ref(c) {
          _this3._dialog = c;
        }
      }), /*#__PURE__*/_react["default"].createElement("div", {
        className: (0, _utils.mapToCssModules)((0, _classnames["default"])('modal-content', modalSquare && 'square', modalMobile && 'mobile', this.props.contentClassName), this.props.cssModule)
      }, this.props.children));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
        ...
        var _this$props3 = this.props,
            ...
            external = _this$props3.external,
