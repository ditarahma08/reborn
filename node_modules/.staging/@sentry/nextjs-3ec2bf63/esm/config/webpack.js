...
function addSentryToEntryProperty(currentEntryProperty, buildContext) {
    return __awaiter(this, void 0, void 0, function () {
        var newEntryProperty, _a, userConfigFile, entryPointName;
...
function addFileToExistingEntryPoint(entryProperty, entryPointName, filepath) {
    ...
    if (typeof currentEntryPoint === 'string') {
        ...
        newEntryPoint = __spread([filepath], currentEntryPoint);
    }
    // descriptor object (webpack 5+)
        ...
        if (typeof currentImportValue === 'string') {
            ...
            newImportValue = __spread([filepath], currentImportValue);
        }
        ...
        console.error('Sentry Logger [Error]:', "Could not inject SDK initialization code into entry point " + entryPointName + ", as it is not a recognized format.\n", "Expected: string | Array<string> | { [key:string]: any, import: string | Array<string> }\n", "Got: " + currentEntryPoint);
        return;
    }
...
function getWebpackPluginOptions(buildContext, userPluginOptions) {
    ...
    var serverInclude = isServerless
        ...
        : [{ paths: ['.next/server/pages/'], urlPrefix: urlPrefix + "/server/pages" }].concat(isWebpack5 ? [{ paths: ['.next/server/chunks/'], urlPrefix: urlPrefix + "/server/chunks" }] : []);
    var clientInclude = [{ paths: ['.next/static/chunks/pages'], urlPrefix: urlPrefix + "/static/chunks/pages" }];
